...
export const DEFAULT_ROLE_MATRIX: Record<RoleKey, RoleDefinition> = {
  ...
  LAB_TECHNICIAN: {
    ...
    permissions: [G.patients.read, G.lab.order, G.lab.process, G.reports.read],
  },
  RADIOLOGY_TECHNICIAN: {
    key: 'RADIOLOGY_TECHNICIAN',
    name: 'Radiology Technician',
    description: 'Imaging orders and acquisition.',
    permissions: [G.patients.read, G.lab.order, G.reports.read],
  },
  RECEPTIONIST: {
    key: 'RECEPTIONIST',
    name: 'Receptionist',
  ...
  RECORDS_OFFICER: {
    ...
    permissions: [G.patients.read, G.patients.update, G.reports.read],
  },
  MANAGER: {
    key: 'MANAGER',
    name: 'Manager',
  ...
  PATIENT: {
    ...
    permissions: [G.patients.read, G.appointments.read],
  },
};
